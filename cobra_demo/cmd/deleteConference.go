...
func init() {
	...
	deleteConferenceCmd.Flags().StringP("conf", "c", "", "Name of conference to delete")
	deleteConferenceCmd.MarkFlagRequired("conf")

	// Here you will define your flags and configuration settings.

	// Cobra supports Persistent Flags which will work for this command
	// and all subcommands, e.g.:
	// deleteConferenceCmd.PersistentFlags().String("foo", "", "A help for foo")

	// Cobra supports local flags which will only run when this command
	// is called directly, e.g.:
	// deleteConferenceCmd.Flags().BoolP("toggle", "t", false, "Help message for toggle")
}
